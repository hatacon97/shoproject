...
router.post('/registe', async function(req, res, next){
  const param = [req.body.user_nm, req.body.user_ph, req.body.user_email, req.body.user_pw, req.body.sample6_postcode,
    req.body.sample6_address, req.body.sample6_detailAddress]
